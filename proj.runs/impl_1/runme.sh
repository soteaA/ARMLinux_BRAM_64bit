...
HD_PWD=/home/einsamer-wolf/Vivado/part/bm_trans_v2/proj/proj.runs/impl_1
cd "$HD_PWD"
...
EAStep vivado -log bm_trans_bram_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source bm_trans_bram_wrapper.tcl -notrace
