...
HD_PWD=/home/einsamer-wolf/Vivado/part/bm_trans_v2/proj/proj.runs/synth_1
cd "$HD_PWD"
...
EAStep vivado -log bm_trans_bram_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source bm_trans_bram_wrapper.tcl
